...
<div class="container">
 ...
 <!-- Link para acessar a lista de pets cadastrados -->
 <p style="text-align: center; margin-top: 1rem;">
            <a href="lista.php" style="color: #4a90e2; text-decoration: none;">Ver lista de Pets cadastrados</a>
        </p>
        <!-- Botão/link para visualizar a lista de registros -->
<p style="text-align: center; margin-top: 1rem;">
    <a href="respostas.php" style="color: #4a90e2; text-decoration: none; font-weight: bold; padding: 10px; border-radius: 5px; background-color: #f0f0f0; display: inline-block;">
        Ver respostas cadastradas
    </a>
</p>
